...
def Train(args, model, ad_net, train_dataloader1, train_dataloader2, train_dataloader3, optimizer, optimizer_ad, scheduler, scheduler_ad,
          epoch, writer):
    """Train."""
...
def main():
    ...
    if args.sourceDataset == 'FER2013Plus+SFEW':
        ...
        train_dataset1 = RafDataSet(args.raf_path, phase='train', transform=data_transforms, basic_aug=True)
        train_dataset2 = FER2013PlusDataSet(args.fer2013plus_path, phase='train', transform=data_transforms, basic_aug=True)

...
# Example Code
tmp = torch.randn((16, 768, 14, 14)).to(device)
augmented_conv1 = AugmentedConv(in_channels=768, out_channels=768, kernel_size=3, dk=384, dv=384, Nh=16, relative=True,
                                padding=1, stride=1, shape=14).to(device)
...
augmented_conv2 = AugmentedConv(in_channels=3, out_channels=20, kernel_size=3, dk=40, dv=4, Nh=4, relative=True,
                                padding=1, stride=1, shape=32).to(device)
